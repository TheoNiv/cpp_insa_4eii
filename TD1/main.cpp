...
int main()
{
	...
	//int val = 5; // @000000777C16F694 ->5
	//int &ref = val; // @000000777C16F694 ->5
	//ref = 1; // @000000777C16F694 ->1
	//ref++; // @000000777C16F694 ->2
	//cout << val << " " << ref << endl; // 2 2
	//cout << &val << " " << &ref << endl; // 000000777C16F694 000000777C16F694
